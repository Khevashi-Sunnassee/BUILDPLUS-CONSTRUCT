...
const productionNavItems = [
  ...
  { title: "Drafting Emails", url: "/drafting-emails", icon: Inbox },
...
const urlToFunctionKey: Record<string, string> = {
  ...
  "/broadcast": "broadcast",
  "/production-slots": "production_slots",
  "/production-schedule": "production_report",
  "/production-report": "production_report",
  "/drafting-program": "drafting_program",
  "/drafting-emails": "drafting_program",
  "/daily-reports": "daily_reports",
  "/procurement-reo": "reo_scheduling",
