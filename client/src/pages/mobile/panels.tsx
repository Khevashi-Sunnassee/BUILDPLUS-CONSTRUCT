...
import { AlertTriangle, ClipboardList, Layers, Building2, ChevronRight, ChevronLeft } from "lucide-react";
...
export default function MobilePanelsPage() {
  ...
  const { data: panels = [], isLoading, isError, refetch } = useQuery<Panel[]>({
  ...
  return (
    <div className="flex flex-col h-screen-safe bg-[#070B12] text-white overflow-hidden" role="main" aria-label="Mobile Panels">
