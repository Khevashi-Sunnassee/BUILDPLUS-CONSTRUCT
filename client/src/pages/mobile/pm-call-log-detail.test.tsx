...
vi.mock("wouter", () => ({
  useLocation: () => ["/mobile/pm-call-logs/1", vi.fn()],
...
import MobilePmCallLogDetailPage from "./pm-call-log-detail";

describe("MobilePmCallLogDetailPage", () => {
  beforeEach(() => {
    mockUseQuery.mockReturnValue({ data: null, isLoading: false });
  });

  it("renders the PM call log detail page", () => {
    const { container } = renderWithProviders(<MobilePmCallLogDetailPage />);
