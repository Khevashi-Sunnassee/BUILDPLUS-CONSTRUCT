...
export default function MobileJobDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col h-screen-safe bg-[#070B12] text-white" role="main" aria-label="Mobile Job Detail">
  ...
  if (!job) {
    return (
      <div className="flex flex-col h-screen-safe bg-[#070B12] text-white items-center justify-center" role="main" aria-label="Mobile Job Detail">
  ...
  return (
    <div className="flex flex-col h-screen-safe bg-[#070B12] text-white overflow-hidden" role="main" aria-label="Mobile Job Detail">
