...
vi.mock("wouter", () => ({
  useLocation: () => ["/mobile/photos", vi.fn()],
...
import MobilePhotoGallery from "./photo-gallery";
...
describe("MobilePhotoGallery", () => {
  ...
  it("renders the photo gallery page", () => {
    renderWithProviders(<MobilePhotoGallery />);
    expect(screen.getByTestId("mock-mobile-nav")).toBeInTheDocument();
  });

  it("shows loading state when data is loading", () => {
    mockUseQuery.mockReturnValue({ data: undefined, isLoading: true });
    const { container } = renderWithProviders(<MobilePhotoGallery />);
    expect(container.firstChild).toBeInTheDocument();
  });

  it("displays photo gallery heading", () => {
    renderWithProviders(<MobilePhotoGallery />);
