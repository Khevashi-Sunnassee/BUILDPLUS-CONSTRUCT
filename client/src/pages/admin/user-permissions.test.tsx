...
vi.mock("wouter", () => ({
  useLocation: () => ["/admin/user-permissions", vi.fn()],
...
describe("UserPermissionsPage", () => {
  it("renders the page", () => {
    ...
    renderWithProviders(<UserPermissionsPage />);
  ...
  it("has accessible attributes", () => {
    mockUseQuery.mockReturnValue({ data: [], isLoading: false, refetch: vi.fn() });
    renderWithProviders(<UserPermissionsPage />);
    expect(screen.getByRole("main")).toHaveAttribute("aria-label", "User Permissions");
