...
export const PROCUREMENT_ROUTES = {
  ...
  CUSTOMERS_WITH_JOBS: '/api/customers/with-jobs',
  ...
  SUPPLIERS_WITH_POS: '/api/procurement/suppliers/with-purchase-orders',
...
export const MYOB_ROUTES = {
  ...
  MONTHLY_PNL: '/api/myob/monthly-pnl',
  TAX_CODES: '/api/myob/tax-codes',
  ACCOUNT_MAPPINGS: '/api/myob/account-mappings',
  ...
  IMPORT_SUPPLIERS: '/api/myob/import-suppliers',
  IMPORT_JOBS: '/api/myob/import-jobs',
  ...
  AGED_PAYABLES: '/api/myob/aged-payables',
  AGED_RECEIVABLES: '/api/myob/aged-receivables',
